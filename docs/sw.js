const CACHE_NAME = 'kirapara-pwa-shell-v28';
const APP_SHELL = [
  './','./index.html','./gap.html','./styles.css','./ai.css','./share.css','./theme-kawaii.css','./layout-fixes.css','./gallery-strip.css','./month-sections.css','./early-info.css','./topics.css','./menu.css','./menu-install.css','./gap.css','./app.js','./feed-status.js','./topics.js','./x-image-fix.js','./ui_fixes.js','./gallery-strip.js','./month-sections.js','./early-info.js','./share.js','./menu.js','./menu-install.js','./theme-kawaii.js','./gap.js','./manifest.webmanifest','./icon.svg'
];
